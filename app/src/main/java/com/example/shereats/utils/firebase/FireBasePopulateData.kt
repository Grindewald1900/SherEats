...
class FireBasePopulateData {
    companion object{
        ...
        fun populateDish(){
            RealtimeUtil.addDish("1", "McDonalds", 1 , "Big Mac Bacon", "burger", 10.0, 1.0, 4.1)
            RealtimeUtil.addDish("1", "McDonalds", 2 , "Double Western BBQ Quarter Pounder", "burger", 12.5, 1.0, 3.9)
            RealtimeUtil.addDish("2", "Tim Hortons", 3 , "Brewed Coffee", "coffee", 1.76, 0.9, 2.7)
            RealtimeUtil.addDish("2", "Tim Hortons", 4 , "Crispy Chicken Sandwich", "sandwish", 3.98, 1.0, 4.5)
            RealtimeUtil.addDish("2", "Tim Hortons", 5 , "Beef Burger", "burger", 4.99, 1.0, 4.4)
            RealtimeUtil.addDish("3", "Sushi King", 6, "Salmon Sushi 6 pcs", "sushi", 5.95, 0.8, 4.9 )
            RealtimeUtil.addDish("3", "Sushi King", 7 , "Mix Salade", "salade", 7.75, 1.0, 5.0)
            RealtimeUtil.addDish("4", "Chez Stanley", 8 , "Salade grecque", "salade", 15.0, 0.6, 2.8)
            RealtimeUtil.addDish("4", "Chez Stanley", 9 , "Pepsi", "beverage", 12.5, 2.5, 3.6)
            RealtimeUtil.addDish("4", "Chez Stanley", 10 , "Stanly Pizza", "pizza", 17.4, 1.0, 3.4)
            RealtimeUtil.addDish("5", "Antidote FoodLab", 11 , "Salmon", "fish dishes", 28.0, 1.0, 3.2)
            RealtimeUtil.addDish("5", "Antidote FoodLab", 12 , "Duck Breast", "duck dishes", 35.0, 0.7, 3.9)
            RealtimeUtil.addDish("5", "Antidote FoodLab", 13 , "Toscana Pietranera 2018, Piaggia", "wine", 130.0, 1.0, 4.3)
            RealtimeUtil.addDish("6", "Chez Freddy Pizzeria", 14 , "Italian Pizza", "pizza", 15.99, 1.0, 4.7)
            RealtimeUtil.addDish("6", "Chez Freddy Pizzeria", 15 , "Club Sandwish", "sandwish", 13.99, 1.0, 4.0)
            RealtimeUtil.addDish("7", "Sballo", 16 , "Carnaroli Risotto Seafood", "seafood dishes", 38.0, 1.0, 3.8)
            RealtimeUtil.addDish("7", "Sballo", 17 , "Filettino di bue del Conte", "beef dishes", 42.0, 0.95, 3.5)
            RealtimeUtil.addDish("8", "Restaurant An Phu", 18 , "Chicken Fried", "chicken dishes", 18.0, 1.0, 5.0)
            RealtimeUtil.addDish("8", "Restaurant An Phu", 19 , "Fried Noodle", "noodle/pasta", 17.5, 1.0, 4.7)
            RealtimeUtil.addDish("8", "Restaurant An Phu", 20 , "Sauteed Chicken in Peanut Sauce", "chicken dishes", 9.5, 1.0, 4.3)
